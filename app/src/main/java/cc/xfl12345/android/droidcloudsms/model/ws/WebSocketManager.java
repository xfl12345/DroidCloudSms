...
public class WebSocketManager {
    ...
    public WebSocketManager(OkHttpClient client, Request request, StatusListener statusListener) {
        this.client = client;
    ...
    public void reconnect() {
        ...
        }, WebSocketManager.class.getName() + "_reconnect").start();
    }
    ...
    public void close() {
        if (isConnected()) {
            ...
            Thread thread = new Thread(() -> {
                ...
                webSocket.cancel();
                manualClose = false;
            }, WebSocketManager.class.getName() + "_wait_normal_close");
            thread.start();
            try {
                thread.join();
            } catch (InterruptedException e) {
